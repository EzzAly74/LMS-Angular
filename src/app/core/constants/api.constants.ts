...
export const API = {
  ...
  NOTIFICATIONS_MINE:              `${API_BASE}/notifications/mine`,
  NOTIFICATIONS_MINE_UNREAD_COUNT: `${API_BASE}/notifications/mine/unread-count`,
  NOTIFICATIONS_MINE_READ_ALL:     `${API_BASE}/notifications/mine/read-all`,
  notificationMarkRead: (id: string) => `${API_BASE}/notifications/mine/${id}/read`,
