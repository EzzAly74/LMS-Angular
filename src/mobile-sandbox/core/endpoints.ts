...
export const ENDPOINTS: EndpointDef[] = [
  ...
  {
    id: 'academy_categories',
    step: 3,
    journey: 'Courses List',
    method: 'GET',
    label: 'Category chips (S-02)',
  ...
  },
  {
    ...
    params: [
      { name: 'compoundId', in: 'path', type: 'string', required: true, default: 'exam:1', help: 'Compound id e.g. exam:123 / evaluation:456' },
    ],
    features: ['Error responses', 'Locale'],
    notes: 'Use a compound id taken from the certificates list. 404 when not owned/derivable.',
    manualOnly: true,
  },
  {
    ...
    params: [
      { name: 'compoundId', in: 'path', type: 'string', required: true, default: 'exam:1', help: 'Compound id e.g. exam:123' },
    ],
